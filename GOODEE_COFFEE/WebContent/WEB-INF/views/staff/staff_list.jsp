...
<body>
   ...
   <script type="text/javascript">
    ...
    <div id="saffList">
        ...
        <div id="ListbtnBox">
            <a href="${pageContext.request.contextPath}/staff/staff_withdraw"><button id="movetoWithdraw">삭제</button></a>
            <a href="${pageContext.request.contextPath}/staff/staff_alterInfo"><button id="movetoAlter">수정</button></a>
            <a href="${pageContext.request.contextPath}/staff/staff_rigister"><button id="movetoRegi">등록</button></a>
        </div>
    </div>
</body>
</html>